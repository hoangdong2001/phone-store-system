...
namespace WebOrders.Controllers
{
    public class detailOrdersController : Controller
    {
        ...
        public ActionResult Details(int? idOrder, int? idItem)
        {
            if (idOrder == null || idItem == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            detailOrder detailOrder = db.detailOrders.Find(idOrder, idItem);
            if (detailOrder == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Edit(int? idOrder, int? idItem)
        {
            if (idOrder == null || idItem == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        public ActionResult Delete(int? idOrder, int? idItem)
        {
            if (idOrder == null || idItem == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int? idOrder, int? idItem)
        {
            detailOrder detailOrder = db.detailOrders.Find(idOrder, idItem);
